...
public class TelaScript extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Descrição", "Hora inicial", "Hora final", "Total"
            }
        ) {
    ...
    private void jMenu2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenu2ActionPerformed
        new TelaListaUsuario(this, true).setVisible(true);
    }//GEN-LAST:event_jMenu2ActionPerformed

    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        new TelaListaUsuario(this, true).setVisible(true);    }//GEN-LAST:event_jMenuItem5ActionPerformed
